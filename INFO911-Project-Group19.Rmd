...
toRemove = c("ApplStandard",	"MEPSComp",	"N.Standard", "Family Name", "Sold_in",	"Submit_ID",	"SubmitStatus", "Demand.Response", "Capability",	"Product.Class", "Demand.Response.1",	"Availability.Status",	"Product Website",	"Representative Brand URL",	"Registration.Number", "Country", "Model_No", "ExpDate", "Type", "Phase")
